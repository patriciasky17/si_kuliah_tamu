...
@section('css')
    ...
    <link rel="stylesheet" href="./assets/css/style-documentation-inside.css">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <form class="button-download">
                    <a href="./assets/pradita.mp4" download class="btn btn-outline-warning" role="button" aria-pressed="true">Download Video Dokumentasi</a>
                </form>
            </div>
...
@section('js')
    <script src ="./assets/js/script-magnetic-popup.js"></script>
