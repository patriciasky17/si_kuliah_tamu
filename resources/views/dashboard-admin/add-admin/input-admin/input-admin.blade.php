            ...
            <div class="col-sm-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('user.store') }}" method='POST'>
                        ...
                        @csrf
                        <div class="row mb-3">
                            <label for="inputNIMMahasiswa" class="col-sm-2 col-form-label">Email</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label for="inputNamaMahasiswa" class="col-sm-2 col-form-label">Username</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label for="inputJenisKelaminMahasiswa" class="col-sm-2 col-form-label">Password</label>
                            <div class="col-sm-10">
