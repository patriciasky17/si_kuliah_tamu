...
<head>
    <meta charset="utf-8">
    <title>Admin Dashboard - Pradita University's Guest Lecturers</title>
        ...
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="input-mahasiswa.html" class="dropdown-item">Input Mahasiswa</a>
                        <a href="detail-mahasiswa.html" class="dropdown-item">Data Mahasiswa</a>
                    </div>
                </div>
